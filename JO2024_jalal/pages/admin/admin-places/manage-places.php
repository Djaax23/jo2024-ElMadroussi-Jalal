...
<head>
    ...
    <title>Lieux des Sports - Jeux Olympiques 2024</title>
    <style>
...
<body>
    ...
    <main>
        ...
        try {
            // Requête pour récupérer la liste des lieu depuis la base de données
            $query = "SELECT nom_epreuve, LIEU.nom_lieu, ville_lieu,adresse_lieu,cp_lieu,id_epreuve,LIEU.id_lieu
            FROM epreuve
            ...
            if ($statement->rowCount() > 0) {
                echo "<table><tr><th>Sport</th><th>Lieux</th><th>Adresse</th><th>Code postal</th><th>Ville</th><th>Modifier</th></tr>";
